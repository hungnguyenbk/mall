...
/**
 * Home carousel advertisement management Controller
 * Created by macro on 2018/11/7.
 */
@Controller
@Api(tags = "SmsHomeAdvertiseController")
@Tag(name = "SmsHomeAdvertiseController", description = "Home Carousel Advertisement Management")
...
public class SmsHomeAdvertiseController {
    ...
    @ApiOperation("Change online/offline status")
    ...
    @ApiOperation("List advertisements (paged)")
